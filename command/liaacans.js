...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, jpegThumbnail: global.thumb, surface: 200, message: '©Created By ZENNBOT', orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
let menunyaa = `Menampilkan List Menu ZENNBOT
...
const listMessage = {
  text: menunyaa,
  footer: "© Created By ZENNBOT",
  title: "━━━[ LIST MENU ZENNBOT ]━━━",
...
Instagram : https://instagram.com/zenixdcode
Tiktok : https://tiktok.com/@ryuuna'

❖ Link Base Script ❖
https://github.com/LORD-Zenix/base-device
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM BROTHER BY ZENNBOT"
	}
],
...
case 'confirmorderkunci': { //KUNCI = BIAR GA DIAKSES HEHE
				...
				if (feta.status == false) {
  				...
  				liaacans.sendMessage(m.chat, {
    				caption: cap, image: {
      				url: feta.data.qris
    				}, buttons: buto, footer: `©Created ZENNBOT`
  				})
				}
				console.log(feta)
				}
