...
###################################-+
# author   : nandadev                        #-+
# insta    : instagram.com/zenixdcode    #-+
# tiktok   : tiktok.com@ryuuna'                 #-+
# whatsapp : 085701863281                       #-+
###################################-+
...
tempat_tinggal = ["tempat tinggal saya di mesin :)","jangan tanya mulu Nanda lagi pms"]
jadi = ["Saya mau menjadi pacarmu kok","ya mau dong hehe","ya mau lah","Nanda mau kok","Mau dong"]
...
rindu2 = ["jangan rindu kamu gaakan kuat biar Nanda saja","Nanda juga rindu :("]
...
while(True):
 ...
 if re.findall(r"hallo", user):
    ...
    print("Nanda : ", random.choice(bot2))
 elif re.findall(r"siapa namamu?|namamu siapa?", user): 
    print("Nanda : ", random.choice(nama))
 elif re.findall(r"kenalan yok?|kenalan yuk?", user):
    print("Nanda : ", random.choice(kenalan))
 elif re.findall(r"boleh kenalan?|boleh kenalan ga nih?", user):
    print("Nanda : ", random.choice(kenalan2))
 elif re.findall(r"darimana asalmu?|asalmu darimana?|dimana asalmu?|asalmu dimana ?|kalo boleh tau asalmu darimana?", user):
    print("Nanda : ", random.choice(asal))
 elif re.findall(r"siapa penciptamu?|siapa yang membuat kamu?|siapa pembuatmu?|pembuatmu siapa?|penciptamu siapa?", user):
    print("Nanda : ", random.choice(cipta))
 elif re.findall(r"dimana tempat tinggalmu?|dimana tinggalmu|tinggal dimana kamu?|kamu tinggal dimana?|Nanda tinggal dimana?|dimana tempat tinggal mu?|dimana tempatmu?", user):
    print("Nanda : ", random.choice(tempat_tinggal))
 elif re.findall(r"apakah kau mau menjadi pacarku?|apakah kamu mau menjadi pacarku?|apa kamu mau menjadi pacarku?|kamu mau ga jadi pacarku?|kamu mau jadi pacarku?|kamu mau jadi pacarku?|Nanda mau jadi pacarku?|Nanda mau ga jadi pacarku?|mau ga jadi pacar aku?", user):
 	  print("Nanda : ", random.choice(jadi)) 
    ...
    print("Nanda : ", random.choice(ganteng))
    ...
    print("Nanda : ", random.choice(rindu))
    ...
    print("Nanda : ", random.choice(kangen))
    ...
    print("Nanda : ", random.choice(rindu2))
    ...
    print("Nanda : ", random.choice(crnmbk))
 else:
    print("[ERROR] : ", random.choice(gadaperintah))


#// Follow My Github Account LORDZenix //#
